...
const secret = Buffer.from(process.env.REACT_APP_JWT_SECRET || "MIIEvgIBADANBgkqhkiG9w0BAQEFAASCBKgwggS")
...
export async function verifyJWT(jwt: string, api: string): Promise<number | any> {
  try {
